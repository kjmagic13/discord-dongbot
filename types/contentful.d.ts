...
/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type Command = Entry & {
  ...
  contentfulMetadata: ContentfulMetadata;
  description?: Maybe<Scalars['String']>;
  linkedFrom?: Maybe<CommandLinkingCollections>;
  sys: Sys;
  title?: Maybe<Scalars['String']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type CommandBodyArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type CommandCommandArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type CommandDescriptionArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type CommandLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/command) */
export type CommandTitleArgs = {
  locale?: InputMaybe<Scalars['String']>;
};

export type CommandCollection = {
  __typename?: 'CommandCollection';
  items: Array<Maybe<Command>>;
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  total: Scalars['Int'];
};
...
export type CommandFilter = {
  AND?: InputMaybe<Array<InputMaybe<CommandFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CommandFilter>>>;
  ...
  command_contains?: InputMaybe<Scalars['String']>;
  command_exists?: InputMaybe<Scalars['Boolean']>;
  command_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  command_not?: InputMaybe<Scalars['String']>;
  command_not_contains?: InputMaybe<Scalars['String']>;
  command_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  description?: InputMaybe<Scalars['String']>;
  description_contains?: InputMaybe<Scalars['String']>;
  description_exists?: InputMaybe<Scalars['Boolean']>;
...
export type CommandLinkingCollections = {
  __typename?: 'CommandLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};


export type CommandLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
...
/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/home) */
...
/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/home) */
export type HomeBodyArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/home) */
export type HomeButtonTextArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** [See type definition](https://app.contentful.com/spaces/xi0u5d8isq4e/content_types/home) */
export type HomeButtonUrlArgs = {
  locale?: InputMaybe<Scalars['String']>;
};
...
export type Query = {
  ...
  commandCollection?: Maybe<CommandCollection>;
  entryCollection?: Maybe<EntryCollection>;
  home?: Maybe<Home>;
  homeCollection?: Maybe<HomeCollection>;
};
...
export type QueryCommandCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<CommandOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
